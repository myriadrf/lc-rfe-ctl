...
#define SPI2_PM_B_SCK_Pin GPIO_PIN_0
#define SPI2_PM_B_SCK_GPIO_Port GPIOA
#define GPIO_LED_Pin GPIO_PIN_1
#define GPIO_LED_GPIO_Port GPIOA
#define SPI2_PM_B_MOSI_Pin GPIO_PIN_4
#define SPI2_PM_B_MOSI_GPIO_Port GPIOA
#define SPI1_PM_A_SCK_Pin GPIO_PIN_5
#define SPI1_PM_A_SCK_GPIO_Port GPIOA
#define GPIO_PM_B_CONV_Pin GPIO_PIN_6
#define GPIO_PM_B_CONV_GPIO_Port GPIOA
#define SPI1_PM_A_MOSI_Pin GPIO_PIN_7
#define SPI1_PM_A_MOSI_GPIO_Port GPIOA
